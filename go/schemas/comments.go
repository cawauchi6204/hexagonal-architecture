...
func (r *commentR) GetUsersComments() UsersCommentSlice {
	if r == nil {
		return nil
	}
...
var (
	...
	commentColumnsWithoutDefault = []string{"id", "post_id", "user_id", "content"}
...
func (q commentQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Comment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schemas: failed to execute a one query for comments")
	}
...
func (q commentQuery) All(ctx context.Context, exec boil.ContextExecutor) (CommentSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "schemas: failed to assign all query results to Comment slice")
	}
...
func (q commentQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schemas: failed to count comments rows")
	}
...
func (q commentQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "schemas: failed to check if comments exists")
	}
...
func (o *Comment) UsersComments(mods ...qm.QueryMod) usersCommentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`users_comments`.`comment_id`=?", o.ID),
	)
...
func (commentL) LoadUsersComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeComment interface{}, mods queries.Applicator) error {
	var slice []*Comment
	var object *Comment
	...
	query := NewQuery(
		...
		qm.WhereIn(`users_comments.comment_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Comment) AddUsersComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsersComment) error {
	var err error
...
// Sets o.R.Comment's UsersComments accordingly.
// Replaces o.R.UsersComments with related.
// Sets related.R.Comment's UsersComments accordingly.
func (o *Comment) SetUsersComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsersComment) error {
	query := "update `users_comments` set `comment_id` = null where `comment_id` = ?"
...
func (o *Comment) RemoveUsersComments(ctx context.Context, exec boil.ContextExecutor, related ...*UsersComment) error {
	if len(related) == 0 {
		return nil
	}
...
func FindComment(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Comment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schemas: unable to select from comments")
	}
...
func (o *Comment) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("schemas: no comments provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to insert into comments")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to populate default values for comments")
	}
...
func (o *Comment) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("schemas: unable to update comments, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to update comments row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: failed to get rows affected by update for comments")
	}
...
func (q commentQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to update all for comments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to retrieve rows affected for comments")
	}
...
func (o CommentSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to update all in comment slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to retrieve rows affected all in update all comment")
	}
	return rowsAff, nil
}
...
func (o *Comment) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("schemas: no comments provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("schemas: unable to upsert comments, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to upsert for comments")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to retrieve unique values for comments")
	}
...
func (o *Comment) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("schemas: no Comment provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to delete from comments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: failed to get rows affected by delete for comments")
	}
...
func (q commentQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("schemas: no commentQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to delete all from comments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: failed to get rows affected by deleteall for comments")
	}
...
func (o CommentSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to delete all from comment slice")
	}
...
func (o *CommentSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to reload all in CommentSlice")
	}
...
func CommentExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "schemas: unable to check if comments exists")
	}
