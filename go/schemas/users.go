...
var UserRels = struct {
	...
	FollowedFollowers: "FollowedFollowers",
	Posts:             "Posts",
	Threads:           "Threads",
...
type userR struct {
	...
	FollowedFollowers FollowerSlice     `boil:"FollowedFollowers" json:"FollowedFollowers" toml:"FollowedFollowers" yaml:"FollowedFollowers"`
	Posts             PostSlice         `boil:"Posts" json:"Posts" toml:"Posts" yaml:"Posts"`
	Threads           ThreadSlice       `boil:"Threads" json:"Threads" toml:"Threads" yaml:"Threads"`
	UsersComments     UsersCommentSlice `boil:"UsersComments" json:"UsersComments" toml:"UsersComments" yaml:"UsersComments"`
...
func (r *userR) GetFollowedFollowers() FollowerSlice {
	if r == nil {
		return nil
	}
	return r.FollowedFollowers
}
...
func (r *userR) GetThreads() ThreadSlice {
	if r == nil {
		return nil
	}
	return r.Threads
...
func (r *userR) GetUsersComments() UsersCommentSlice {
	if r == nil {
		return nil
	}
	return r.UsersComments
}

func (r *userR) GetUsersTags() UsersTagSlice {
	if r == nil {
		return nil
	}
	return r.UsersTags
...
var (
	...
	userColumnsWithoutDefault = []string{"id", "username", "email", "password_hash"}
...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schemas: failed to execute a one query for users")
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "schemas: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schemas: failed to count users rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "schemas: failed to check if users exists")
	}
...
// FollowedFollowers retrieves all the follower's Followers with an executor via followed_id column.
func (o *User) FollowedFollowers(mods ...qm.QueryMod) followerQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`followers`.`followed_id`=?", o.ID),
	)
...
// Threads retrieves all the thread's Threads with an executor.
func (o *User) Threads(mods ...qm.QueryMod) threadQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`threads`.`user_id`=?", o.ID),
	)

	return Threads(queryMods...)
}

// UsersComments retrieves all the users_comment's UsersComments with an executor.
func (o *User) UsersComments(mods ...qm.QueryMod) usersCommentQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`users_comments`.`user_id`=?", o.ID),
	)

	return UsersComments(queryMods...)
}

// UsersTags retrieves all the users_tag's UsersTags with an executor.
func (o *User) UsersTags(mods ...qm.QueryMod) usersTagQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`users_tags`.`user_id`=?", o.ID),
	)
...
// LoadFollowedFollowers allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadFollowedFollowers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`followers`),
		qm.WhereIn(`followers.followed_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.FollowedFollowers = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &followerR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.FollowedID {
				local.R.FollowedFollowers = append(local.R.FollowedFollowers, foreign)
				if foreign.R == nil {
					foreign.R = &followerR{}
				}
...
// LoadThreads allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadThreads(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`threads`),
		qm.WhereIn(`threads.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load threads")
	}

	var resultSlice []*Thread
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice threads")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on threads")
	}
	if err = results.Err(); err != nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.UserID) {
				local.R.Threads = append(local.R.Threads, foreign)
				if foreign.R == nil {
					foreign.R = &threadR{}
				}
				foreign.R.User = local
...
// LoadUsersComments allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUsersComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`users_comments`),
		qm.WhereIn(`users_comments.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load users_comments")
	}

	var resultSlice []*UsersComment
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice users_comments")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on users_comments")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for users_comments")
	}
	...
	if singular {
		object.R.UsersComments = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &usersCommentR{}
			}
			foreign.R.User = object
		}
		return nil
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.UserID) {
				local.R.UsersComments = append(local.R.UsersComments, foreign)
				if foreign.R == nil {
					foreign.R = &usersCommentR{}
				}
				foreign.R.User = local
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUsersTags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`users_tags`),
		qm.WhereIn(`users_tags.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) SetComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Comment) error {
	query := "update `comments` set `user_id` = null where `user_id` = ?"
...
func (o *User) AddFollowerFollowers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Follower) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ID, rel.FollowerID, rel.FollowedID}
...
// AddFollowedFollowers adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.FollowedFollowers.
// Sets related.R.Followed appropriately.
func (o *User) AddFollowedFollowers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Follower) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.FollowedID = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			FollowedFollowers: related,
		}
	} else {
		o.R.FollowedFollowers = append(o.R.FollowedFollowers, related...)
	}
...
// AddThreads adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Threads.
// Sets related.R.User appropriately.
func (o *User) AddThreads(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Thread) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
	...
	if o.R == nil {
		...
		o.R.Threads = append(o.R.Threads, related...)
	}
...
// SetThreads removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Threads accordingly.
// Replaces o.R.Threads with related.
// Sets related.R.User's Threads accordingly.
func (o *User) SetThreads(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Thread) error {
	query := "update `threads` set `user_id` = null where `user_id` = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	return o.AddThreads(ctx, exec, insert, related...)
}

// RemoveThreads relationships from objects passed in.
// Removes related items from R.Threads (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
func (o *User) RemoveThreads(ctx context.Context, exec boil.ContextExecutor, related ...*Thread) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.Threads {
			...
			ln := len(o.R.Threads)
			if ln > 1 && i < ln-1 {
				o.R.Threads[i] = o.R.Threads[ln-1]
			}
			o.R.Threads = o.R.Threads[:ln-1]
			break
		}
	}
...
// AddUsersComments adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UsersComments.
// Sets related.R.User appropriately.
func (o *User) AddUsersComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsersComment) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
	...
	if o.R == nil {
		o.R = &userR{
			UsersComments: related,
		}
	} else {
		o.R.UsersComments = append(o.R.UsersComments, related...)
	}
...
// SetUsersComments removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's UsersComments accordingly.
// Replaces o.R.UsersComments with related.
// Sets related.R.User's UsersComments accordingly.
func (o *User) SetUsersComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsersComment) error {
	query := "update `users_comments` set `user_id` = null where `user_id` = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	if o.R != nil {
		for _, rel := range o.R.UsersComments {
			queries.SetScanner(&rel.UserID, nil)
			if rel.R == nil {
				continue
			}
		...
		o.R.UsersComments = nil
	}

	return o.AddUsersComments(ctx, exec, insert, related...)
}

// RemoveUsersComments relationships from objects passed in.
// Removes related items from R.UsersComments (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
func (o *User) RemoveUsersComments(ctx context.Context, exec boil.ContextExecutor, related ...*UsersComment) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.UsersComments {
			if rel != ri {
				continue
			}

			ln := len(o.R.UsersComments)
			if ln > 1 && i < ln-1 {
				o.R.UsersComments[i] = o.R.UsersComments[ln-1]
			}
			o.R.UsersComments = o.R.UsersComments[:ln-1]
			break
		}
	}
...
// Sets related.R.User appropriately.
func (o *User) AddUsersTags(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsersTag) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schemas: unable to select from users")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("schemas: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to insert into users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to populate default values for users")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("schemas: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("schemas: no users provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("schemas: unable to upsert users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to retrieve unique values for users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("schemas: no User provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("schemas: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schemas: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schemas: unable to delete all from user slice")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "schemas: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "schemas: unable to check if users exists")
	}
